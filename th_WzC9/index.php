...
<html>
<head>
	<meta name="google-site-verification" content="F_neEH5siQCnfOm6wTE19SUST2Or9c9HZ2dbSXYk65Y" />
				...
				<div class="gContsBodyDiv">
					<section id="gContsBodyWrap">
						...
						<section class="gContsSideWrap">
								...
								<ul>
									<?php if($_SESSION['user_login'] != 'ok') { ?>
										<form method="post" action="">
											...
											<li>
											  <button name="loginacc" class="mvcore-button-style" type="submit">ENTRAR</button>
											</li>
						  ...
						  <article class="mainRankingWrap" style="height:100%;"></article>
							
							<article class="mainRankingWrap" style="height:100%;">
								<h2>Eventos Tiempo </h2>
								<div class="mainRankingBox" style="height:100%;">
...
<footer style="background-color:#000000;line-height:40px;height:40px;text-align:center;">
	<center><?php echo $mvcore['ads_spt_728x90']; ?> <!-- Leaderboard ( 728 x 90 ) --></center>
	Copyright &copy; 2016-<?php echo date("Y"); ?> <a href="https://mu-tekron.com.ve" class="Estilo1">Mu Tekron</a></footer>
</body>
</html>
